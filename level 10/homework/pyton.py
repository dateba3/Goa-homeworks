...
#input არის რაგაცის შეყვანა ან ეკრანზე გაკეთება მაგალითდ:კლავიატურა არის input
...
number2=input("please enter you card number: ")
number3=input("please enter you date number: ")
number4=input("please enter you number to get it: ")
number5=input("please enter you code that will be sent in you phone: ")
